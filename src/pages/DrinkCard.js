            ...
            <div id='drink_wrap' key={info.idDrink}>
               ...
               <div id='first'>
                <img src={info.strDrinkThumb}alt={info.strDrink}  width="400" height="450" ></img>
                 ...
                 <div id='drink_glass'>
                     <h4>Glass type:</h4> 
                     <img  src={'/glasses/'+ glass +'.png'} alt={info.strDrink}  width="150" height="150" key={info.idDrink}></img>
                     <h6>{info.strGlass}</h6>
                  </div>
                  <div id='method'>
            ...
            return(
              <div id='ing'>
                  <div className='col-sm-6'>
                    <ul>
                      <li key={`${data.ingredient}${data.measurement}`}>{data.ingredient}{data.measurement}</li>
                    </ul>
                  </div>
                  </div>
            )
